                ...
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"
                            aria-current="page">Service Grid</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-12 theiaStickySidebar">
                <div class="filter-div">
                    ...
                    <div class="filter-content">
                        <h2>Categories <span><i
                                    class="feather-chevron-down"></i></span></h2>
                            ...
                            <ul>
                                ...
                                <li>
                                    <label class="checkboxs">
                                        ...
                                        <span><i></i></span>
                                        <b
                                            class="check-content">Construction</b>
                                    </label>
                                </li>
                                <li>
                                    <label class="checkboxs">
                        ...
                        <ul class="rating-set">
                            <li>
                                ...
                                <a class="rating" href="javascript:void(0);">
                                    ...
                                    <span
                                        class="d-inline-block average-rating float-end">(35)</span>
                                </a>
                            </li>
                            <li>
                                <label class="checkboxs d-inline-flex">
                                ...
                                <a class="rating" href="javascript:void(0);">
                                    ...
                                    <i class="fa-regular fa-star"></i>
                                    <span
                                        class="d-inline-block average-rating float-end">(40)</span>
                                </a>
                            </li>
                            <li>
                                <label class="checkboxs d-inline-flex">
                            ...
                            <li>
                                ...
                                <a class="rating" href="javascript:void(0);">
                                    ...
                                    <i class="fa-regular fa-star"></i>
                                    <span
                                        class="d-inline-block average-rating float-end">(20)</span>
                                </a>
                            </li>
                            <li>
                                <label class="checkboxs d-inline-flex">
                                ...
                                <a class="rating" href="javascript:void(0);">
                                    ...
                                    <i class="fa-regular fa-star"></i>
                                    <span
                                        class="d-inline-block average-rating float-end">(5)</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                ...
                                <div class="fav-item">
                                    <a href="categories.html"><span
                                            class="item-cat">Car Wash</span></a>
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Car Repair
                                        Services</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Maryland City,
                                    USA<span class="rate"><i
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Toughened
                                        Glass Fitting Services</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>New Jersey,
                                    USA<span class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$25.00</h6>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                ...
                                <div class="fav-item">
                                    <a href="categories.html"><span
                                            class="item-cat">Computer</span></a>
                                    <a href="javascript:void(0)"
                                        class="fav-icon">
                                        <i class="feather-heart"></i>
                                    </a>
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Computer &
                                        Server AMC Service</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>California,
                                    USA<span class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$20.00<span
                                            class="old-price">$35.00</span></h6>
                                    <a href="booking.html"
                                        class="btn btn-book">Book Now</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                ...
                                <div class="fav-item">
                                    <a href="categories.html"><span
                                            class="item-cat">Interior</span></a>
                                    <a href="javascript:void(0)"
                                        class="fav-icon selected">
                                        <i class="feather-heart"></i>
                                    </a>
                            ...
                            <div class="service-content">
                                ...
                                <p><i class="feather-map-pin"></i>Maryland,
                                    USA<span class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$5.00<span
                                            class="old-price">$25.00</span></h6>
                                    <a href="booking.html"
                                        class="btn btn-book">Book Now</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Steam Car
                                        Wash</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Montana,
                                    USA<span class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$14.00</h6>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Electric
                                        Panel Repairing Service</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Texas,
                                    USA<span class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$45</h6>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                ...
                                <div class="fav-item">
                                    <a href="categories.html"><span
                                            class="item-cat">Cleaning</span></a>
                                    <a href="javascript:void(0)"
                                        class="fav-icon">
                                        <i class="feather-heart"></i>
                                    </a>
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">House
                                        Cleaning Services</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Georgia<span
                                        class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$10.00</h6>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Commercial
                                        Painting Services</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Alabama,
                                    USA<span class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$10.00<span
                                            class="old-price">$15.00</span></h6>
                                    <a href="booking.html"
                                        class="btn btn-book">Book Now</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Building
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                ...
                                <div class="fav-item">
                                    <a href="categories.html"><span
                                            class="item-cat">Plumbing</span></a>
                                    <a href="javascript:void(0)"
                                        class="fav-icon">
                                        <i class="feather-heart"></i>
                                    </a>
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Plumbing
                                        Services</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Virginia,
                                    USA<span class="rate"><i
                                            class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$15.00<span
                                            class="old-price">$45.00</span></h6>
                                    <a href="booking.html"
                                        class="btn btn-book">Book Now</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                ...
                                <div class="fav-item">
                                    <a href="categories.html"><span
                                            class="item-cat">Carpentry</span></a>
                                    <a href="javascript:void(0)"
                                        class="fav-icon">
                                        <i class="feather-heart"></i>
                                    </a>
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Wooden
                                        Carpentry Work</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Alabama,
                                    USA<span class="rate"><i
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Painting
                                        Services</a>
                                </h3>
                                <p><i class="feather-map-pin"></i>Virginia,
                                    USA</p>
